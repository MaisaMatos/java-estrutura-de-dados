...
/*Melhore a classe "VetorLista" e implemente o método "contém", semelhante ao método "contains" 
 * da classe ArrayList
 */

public class VetorListaEx01<T> {

	private T[] elementos;
	private int tamanho;
	
	
	public VetorListaEx01(int capacidade) {
		this.elementos = (T[]) new Object[capacidade];
		this.tamanho = 0; 
	}
	
	
	public VetorListaEx01(int capacidade, Class<T> tipoClasse) {
