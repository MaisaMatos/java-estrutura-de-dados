...
/*Melhore a classe "VetorLista" e implemente o método "limpar", onde todo os elementos
 * da lista são removidos. Semelhante ao método "clear" da classe ArrayList
 */

public class VetorListaEx05<T> {

	private T[] elementos;
	private int tamanho;
	
	
	public VetorListaEx05(int capacidade) {
		this.elementos = (T[]) new Object[capacidade];
		this.tamanho = 0; 
	}
	
	
	public VetorListaEx05(int capacidade, Class<T> tipoClasse) {
