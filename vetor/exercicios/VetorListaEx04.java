...
/*Melhore a classe "VetorLista" e implemente o método "obtem(T elemento)", onde será possível
 * obter o elemento dada uma posição do vetor. Método semelhante ao "get" da classe ArrayList
 */

public class VetorListaEx04<T> {

	private T[] elementos;
	private int tamanho;
	
	
	public VetorListaEx04(int capacidade) {
		this.elementos = (T[]) new Object[capacidade];
		this.tamanho = 0; 
	}
	
	
	public VetorListaEx04(int capacidade, Class<T> tipoClasse) {
